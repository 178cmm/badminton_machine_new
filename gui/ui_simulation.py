...
def _create_settings_group(self):
    ...
    # 雙發球機選項 (保留功能)
    self.simulation_dual_machine_check = QCheckBox("使用雙發球機 (功能保留)")
    ...
    """)
    self.simulation_dual_machine_check.setEnabled(False)  # 暫時禁用
...
def _populate_level_combo(combo):
    ...
    levels = [
        ...
        ("等級 9 - 專業級", 9, "後高中殺前低，間隔 2 秒 (支援雙發球機)"),
        ("等級 10 - 專業級+", 10, "後高中殺前低，間隔 1.5 秒 (支援雙發球機)"),
        ("等級 11 - 大師級", 11, "後高中殺前低，間隔 1.5 秒 (支援雙發球機)"),
        ("等級 12 - 大師級+", 12, "後高中殺前低，間隔 1 秒 (支援雙發球機)")
    ]
